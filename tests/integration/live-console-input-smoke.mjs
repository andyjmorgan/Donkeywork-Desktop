// Explicit minigpu greeter interaction: select user, Escape back. No credentials.
...
try {
  ...
  await page.screenshot({path:'artifacts/console-web/web-input-before.png'});
  ...
  await page.screenshot({path:'artifacts/console-web/web-input-click.png'});
  await page.keyboard.press('Escape');
  await page.waitForTimeout(500);
  await page.screenshot({path:'artifacts/console-web/web-input-escape.png'});
  ...
  console.log(JSON.stringify({url,acquire:true,release:true,reacquire:true,blurRelease:true,secondViewerDenied:true,errors,
